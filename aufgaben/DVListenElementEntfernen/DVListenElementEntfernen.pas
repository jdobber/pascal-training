...
Begin
 ...
 (* wenn gefunden *)
  If gefunden Then
    Begin
      If z = ioListe Then (* erstes Element *)
        Begin
          ioListe := z^.next; (* Listenanfang auf Nachfolger setzen *)

		  (* Verknuepfung zum Vorgaenger kappen, aber nur wenn es einen Nachfolger gab *)
          If ioListe <> Nil Then ioListe^.prev := Nil;

          dispose(z); (* Element loeschen *)
        End
      Else
        Begin    (* Element aus ausketten und loeschen *)
